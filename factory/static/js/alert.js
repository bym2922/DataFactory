...
var Alert={	  
	show3sMsg:function(obj){
		var subhtml='<div id="alert_dialog_show_3s_box" style=" overflow:hidden;"><div id="alert_show_3" class="time1" style="height:100px; width:200px; background-color:#000; color:#fff; opacity:0.8;  border-radius:8px;font-size:24px; text-align:center;z-index: 10001; position:fixed;top:20%;left:45%;"><p style="padding-top:30px;">'+obj+'</p></div></div>';
		$("body").append(subhtml);
		//计数器
		time=3;		
	...
	var subhtml='<div id="alert_dialog_show_confirm_box" style=" overflow:hidden;height:100px;width:200px;margin:15% auto;"><div class="sweet-overlay" tabIndex="-1" style=" background-color:#000; opacity:0.4; position: fixed; left: 0; right: 0; top: 0; bottom: 0; z-index:10002;"></div><div id="alert_show_3" style="height:100px; width:200px; background-color:#fff; color:#000; border-radius:8px;font-size:16px; text-align:center; position:absolute;z-index:12000;top:300px;"><p style="font-size:14px; margin-top:20px;">'+obj+'</p><input name="button" onclick="rec('+callback+') " type="button" value="确认" style=" width:60px; height:30px;line-height:30px; background-color:#428BCA";color:#FFF;font-size:14px;box-shadow:none;border-radius:8px;margin:26px 5px 0 5px;border:none;"  /><input name="button" onclick="rec()" type="button" value="取消" style=" width:60px; height:30px;line-height:30px; background-color:#428BCA";color:#FFF;font-size:14px;box-shadow:none;border-radius:8px;margin:26px 5px 0 5px;border:none;  /></div></div>';
		$("body").append(subhtml);
